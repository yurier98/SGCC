...
urlpatterns = [
    ...
    # path('', TemplateView.as_view(template_name="notifications/notifications.html"), name='notifications_list2'),
    ...
    path("bulk_delete/", views.NotificationBulkDeleteView.as_view(), name="notification_bulk_delete"),
    path("expired_delete/", views.ExpiredNotificationDeleteView.as_view(), name="expired_notification_delete"),
]