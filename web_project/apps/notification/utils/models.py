...
class AbstractNotificacion(models.Model):
	...
	destiny = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='notificaciones', blank=True, null=True)
...
def notify_signals(verb, **kwargs):
	...
	Notify = load_model('notification', 'Notification')
